...
from web_app.api.groups.routers import groups_router
from web_app.api.students.routers import students_router
from web_app.api.courses.routers import courses_router
...
def create_app():
    ...
    app.register_blueprint(courses_router)
